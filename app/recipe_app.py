...
SYSTEM_PROMPT = (
    ...
    "- Before calling prepare_meal_log, split the user's input into: meal_description for user-facing copy, "
    "food_query for nutrition lookup, and food_query_en for English nutrition lookup when the food name is Chinese.\n"
    "- food_query must be a short food or dish phrase only. Never include wrappers like 'I ate', '我晚上吃了', "
    "'帮我记录', or similar intent text in food_query.\n"
